...
//import java.net.URL;
//
//public class testonMobile {
//	
//	DesiredCapabilities caps = new DesiredCapabilities(); // all things that i am used in this app
...
//		caps.setCapability(MobileCapabilityType.DEVICE_NAME,"Mostafa_Alazzam");
//		
//		// browse testing - type(1)
//	
//		/*caps.setCapability("chromdriverExecutable","D:\\QA\\ChromWebDriver\\chromedriver.exe");
//		
//		/* version Chrome (: help -> version info -> show version chrome)
//		(search on chrome web driver at the same version , download (search in your version and download it)) 
//		go to the Run in your desktop and copy the path and space , then show all path 
//	    */
//		 
...
//		
//		driver = new AndroidDriver(new URL("http://127.0.0.1:4723/wd/hub"),caps); // this code is static (always)
//		
...
//		caps.setCapability(MobileCapabilityType.BROWSER_NAME, "chrome");
		...
		File myApp = new File("src/Applications/Calcualtor.apkm");
